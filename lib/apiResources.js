...
module.exports.omiseResources = function(config) {
  omiseConfig = config;
  return {
    sources:      require('./resources/Source')(omiseConfig),
    tokens:       require('./resources/Token')(omiseConfig),
    customers:    require('./resources/Customer')(omiseConfig),
    charges:      require('./resources/Charge')(omiseConfig),
    schedules:    require('./resources/Schedule')(omiseConfig),
    disputes:     require('./resources/Dispute')(omiseConfig),
    transfers:    require('./resources/Transfer')(omiseConfig),
    transactions: require('./resources/Transaction')(omiseConfig),
    recipients:   require('./resources/Recipient')(omiseConfig),
    events:       require('./resources/Event')(omiseConfig),
    links:        require('./resources/Link')(omiseConfig),
    account:      require('./resources/Account')(omiseConfig),
    balance:      require('./resources/Balance')(omiseConfig),
    search:       require('./resources/Search')(omiseConfig),
  };
};
